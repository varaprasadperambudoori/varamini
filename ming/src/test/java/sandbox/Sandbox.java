...
//    private static Logger logger = LogManager.getLogger(sandbox.Sandbox.class);
    ...
    public void testCreateUser() {
        ...
        response = RestUtil.createUser(request, "Varaprasad", "Perambudoori", "varamarqeta03721@mailinator.com", "(949)-572-4426");
        ...
        Assert.assertEquals("varamarqeta03721@mailinator.com", email);
