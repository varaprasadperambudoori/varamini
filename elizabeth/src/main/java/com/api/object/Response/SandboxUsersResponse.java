...
import com.api.object.Response.Metadata.Metadata;
...
public class SandboxUsersResponse {
    ...
    @JsonAnyGetter
    public Map<String, String> getSandboxUsersProperties() {return this.sandboxUsersProperties;}

    @JsonAnySetter
    public void setSandboxUsersProperties(String NAME, String VALUE) {this.sandboxUsersProperties.put(NAME, VALUE);}
}
