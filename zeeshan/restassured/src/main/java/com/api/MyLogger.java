...
public class MyLogger {
    ...
    public void sandboxRestAssuredFramework() {
        ...
        RestAssured.baseURI = url.BASEURI;
        ...
        parameters.put("first_name", "Zeeshan");
        parameters.put("last_name", "Mohamedy");
        parameters.put("active", true);
        parameters.put("email", "zeeshanmohamedy123@gmail.com");
        ...
        Response response = httpRequest.request(Method.POST, url.USERS);		//adds to the body
